...
[![Build Status](https://travis-ci.org/alibaba/transmittable-thread-local.svg?branch=v2.2.1)](https://travis-ci.org/alibaba/transmittable-thread-local)
[![JDK6 Build Status](https://img.shields.io/appveyor/ci/oldratlee/transmittable-thread-local/v2.2.1.svg?label=jdk6%20build)](https://ci.appveyor.com/project/oldratlee/transmittable-thread-local)
[![Coverage Status](https://img.shields.io/codecov/c/github/alibaba/transmittable-thread-local/v2.2.1.svg)](https://codecov.io/gh/alibaba/transmittable-thread-local/branch/v2.2.1)
...
The current version Java API documentation: <http://alibaba.github.io/transmittable-thread-local/apidocs/2.2.1/index.html>
