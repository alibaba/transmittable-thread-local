...
[![Build Status](https://travis-ci.org/alibaba/transmittable-thread-local.svg?branch=v2.10.0)](https://travis-ci.org/alibaba/transmittable-thread-local)
[![Windows Build Status](https://img.shields.io/appveyor/ci/oldratlee/transmittable-thread-local/v2.10.0.svg?label=windows%20build)](https://ci.appveyor.com/project/oldratlee/transmittable-thread-local)
[![Coverage Status](https://img.shields.io/codecov/c/github/alibaba/transmittable-thread-local/v2.10.0.svg)](https://codecov.io/gh/alibaba/transmittable-thread-local/branch/v2.10.0)
...
[![Javadocs](https://www.javadoc.io/badge/com.alibaba/transmittable-thread-local.svg)](http://alibaba.github.io/transmittable-thread-local/apidocs/2.10.0/index.html)
...
The current version Java API documentation: <http://alibaba.github.io/transmittable-thread-local/apidocs/2.10.0/index.html>
