...
<p align="center">
<a href="https://github.com/alibaba/transmittable-thread-local/actions/workflows/ci.yaml"><img src="https://img.shields.io/github/workflow/status/alibaba/transmittable-thread-local/CI/v2.14.1?logo=github&logoColor=white" alt="Github Workflow Build Status"></a>
<a href="https://ci.appveyor.com/project/oldratlee/transmittable-thread-local"><img src="https://img.shields.io/appveyor/ci/oldratlee/transmittable-thread-local/v2.14.1?logo=appveyor&logoColor=white" alt="Appveyor Build Status"></a>
<a href="https://app.codecov.io/gh/alibaba/transmittable-thread-local/tree/v2.14.1"><img src="https://badgen.net/codecov/c/github/alibaba/transmittable-thread-local/v2.14.1?icon=codecov" alt="Coverage Status"></a>
