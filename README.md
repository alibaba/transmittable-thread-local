...
<p align="center">
<a href="https://github.com/alibaba/transmittable-thread-local/actions/workflows/ci.yaml"><img src="https://img.shields.io/github/workflow/status/alibaba/transmittable-thread-local/CI/v2.14.0?logo=github&logoColor=white" alt="Github Workflow Build Status"></a>
<a href="https://ci.appveyor.com/project/oldratlee/transmittable-thread-local"><img src="https://img.shields.io/appveyor/ci/oldratlee/transmittable-thread-local/v2.14.0?logo=appveyor&logoColor=white" alt="Appveyor Build Status"></a>
<a href="https://codecov.io/gh/alibaba/transmittable-thread-local/branch/v2.14.0"><img src="https://img.shields.io/codecov/c/github/alibaba/transmittable-thread-local/v2.14.0?logo=codecov&logoColor=white" alt="Coverage Status"></a>
...
<p>严谨地说，应该是『传递行为』，而不是『拷贝行为』；相应的，这个方法应该命名成<code>transmitteeValue</code>，与<code>InheritableThreadLocal.childValue</code>方法有一致的命名风格。
