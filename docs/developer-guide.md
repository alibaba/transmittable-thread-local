...
![1-preferences](https://user-images.githubusercontent.com/1063891/90236020-c57acd00-de54-11ea-8984-695adaf08a67.png)
...
其它`IDE`（如`Eclipse`）可以找一下设置方法，以关闭这个『语言版本 与 `API`版本』检查。
