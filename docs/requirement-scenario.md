...
分布式跟踪系统的实现的示意Demo参见[`DistributedTracerUseDemo.java`](https://github.com/alibaba/transmittable-thread-local/blob/v2.0.0/src/test/java/com/alibaba/ttl/demo/distributed_tracer/DistributedTracerUseDemo.java)
